...
namespace ApplicationCore.Services
{
    public class MailService : IMailService
    {
        public async Task SendEmailAsync(string personelEmail, string password, string userId)
        {
            ...
            mail.Body += $"<a asp-route-userId=\"{userId}\" href=\"https://peoplelink.gurbuzyasin.com/Identity/Account/PasswordChange?userId={userId}\"> Şifrenizi değiştirmek için buraya tıklayınız</a>\n";
