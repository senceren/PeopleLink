...
namespace Web.Areas.Manager.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.gurbuzyasin.com/api/Leave/" + leave.Id, leave);
        ...
        public async Task<IActionResult> ExpenseRequests(string? status)
        {
            ...
            if (status != null)
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrlWithStatus = $"https://peoplelinkapi.gurbuzyasin.com/api/Expense?status={status}&employeeId={userId}";
            ...
            else
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrl = $"https://peoplelinkapi.gurbuzyasin.com/api/Expense?employeeId={userId}";
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.gurbuzyasin.com/api/Expense/" + expense.Id, expense);
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.gurbuzyasin.com/api/Advance/" + advance.Id, advance);
