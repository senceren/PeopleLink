...
namespace Web.Areas.Manager.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.cerensenyazici.com/api/Leave/" + leave.Id, leave);
        ...
        public async Task<IActionResult> ExpenseRequests(string? status)
        {
            ...
            if (status != null)
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrlWithStatus = $"https://peoplelinkapi.cerensenyazici.com/api/Expense?status={status}&employeeId={userId}";
            ...
            else
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrl = $"https://peoplelinkapi.cerensenyazici.com/api/Expense?employeeId={userId}";
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.cerensenyazici.com/api/Expense/" + expense.Id, expense);
        ...
        {
            var expense = await _httpClient.GetFromJsonAsync<GetExpenseViewModel>($"https://peoplelinkapi.cerensenyazici.com/api/Expense/{expenseId}");
        ...
        public async Task<IActionResult> AdvanceRequests(string? status)
        {
            ...
            if (status != null)
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrlWithStatus = $"https://peoplelinkapi.cerensenyazici.com/api/Advance?status={status}&employeeId={userId}";
            ...
            else
            {
                ...
                {
                    var userId = employee.Id;
                    string apiUrl = $"https://peoplelinkapi.cerensenyazici.com/api/Advance?employeeId={userId}";
        ...
        {
            await _httpClient.PutAsJsonAsync("https://peoplelinkapi.cerensenyazici.com/api/Advance/" + advance.Id, advance);
        ...
        {
            var advance = await _httpClient.GetFromJsonAsync<AdvanceViewModel>($"https://peoplelinkapi.cerensenyazici.com/api/Advance/{advanceId}");
